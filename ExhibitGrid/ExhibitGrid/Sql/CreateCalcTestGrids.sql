...
exec UspUpdAttribVal 'CalcGrid1', '', 'ColOne',		'IsEditable=1,HasHeader=1,IsHidden=0,Type=''numeric'',Width=''120px'',DisplayText=''FY 2015 Program'',ColSpan=1,Level=0,Alignment=''center'',MaxChars=8,DecimalPlaces=2', ''
...
exec UspUpdAttribVal 'CalcGrid1', '', 'ColSix',		'IsEditable=1,HasHeader=1,IsHidden=0,Type=''numeric'',Width=''120px'',DisplayText=''FY 2016 Program'',ColSpan=1,Level=0,Alignment=''center'',MaxChars=8,DecimalPlaces=2', ''
...
exec UspUpdAttribVal 'CalcGrid1', 'Row13', 'ColFive',	'ColSpan=1,IsEditable=1,Indent=0,OverrideColSettings=0,Type=null,MaxChars=5,DecimalPlaces=2,Alignment=''right''', ''
...
where CalcExpressionId in(
	...
	where TargetGridCode = 'CalcGrid1'	
)
delete from CalcOperand where GridCode = 'CalcGrid1'	
delete from CalcExpression where TargetGridCode = 'CalcGrid1'	

DECLARE @CivTotal int, @TravelTotal int, @GrandTotal int, @ProgGrow int, @PriceGrow int
