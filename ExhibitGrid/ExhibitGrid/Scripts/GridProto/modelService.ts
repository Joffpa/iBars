...
module app.services{
    interface IModelService {
        ...
        getModel(): {},
        getColumns(): {},
        getChildRows(rowCode: string, pluckProp: string): {}[],
        addAnotherRow(): void,
    ...
    class ModelService implements IModelService {
        ...
        addAnotherRow() {
            ...
            var cells = [];
            _.forEach(this.viewModel.Rows[0].Cells, function (va, idx: number) {
                if (idx === 0) {
                    cells.push({
        ...
        addAnotherColumn() {
            ...
            _.forEach(this.viewModel.Rows, function (val, idx: number) {
                if (idx == 0) {
                    val.Cells.push({
